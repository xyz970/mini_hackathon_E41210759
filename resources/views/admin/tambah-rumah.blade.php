...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / Rumah /</span> Tambah Data</h4>
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.rumah.add_process') }}" method="post">
                        {{ csrf_field() }}
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="keterangan" class="form-control" name="keterangan" aria-describedby="basic-icon-default-message2"></textarea>
                                </div>
                            </div>
